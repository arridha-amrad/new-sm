...
const NotificationOfCommentPost: FC<Props> = ({ notification, loginUser }) => {
  ...
  return (
    <div className="d-flex align-items-start p-3 gap-3">
      ...
      <div className="d-flex flex-column gap-1">
        <div>{likeHelpers(senders, loginUser)} commented your post</div>
...
export default NotificationOfCommentPost;
